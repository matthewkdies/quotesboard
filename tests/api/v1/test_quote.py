...
def create_author(client: TestClient) -> Author:
    ...
    response = client.put("/api/v1/author", json={"raw_name": "Leroy_Jenkins"})
...
#     quote_json = {"single_quotes"}
#     response = client.put("/api/v1/quote", json={"text": quote_string, "author_id": author.id})
